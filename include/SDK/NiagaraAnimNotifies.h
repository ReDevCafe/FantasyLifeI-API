...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* meshComp);                                              // [0x71086f0] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// float GetNotifyProgress(class UMeshComponent* meshComp);                                                                 // [0x7108650] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect();                                                                            // [0x509e660] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
