...
public:
	...
	SDK_UNDEFINED(80,1181) /* TSet<FRCNetworkAddressRange> */ __um(AllowlistedClients);                            // 0x0088   (0x0050)  
	...
	SDK_UNDEFINED(80,1182) /* TSet<FName> */           __um(EntitiesListHiddenColumns);                            // 0x0108   (0x0050)  
