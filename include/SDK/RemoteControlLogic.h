...
{ 
public:
	SDK_UNDEFINED(80,1195) /* TSet<URCActionContainer*> */ __um(ActionContainers);                                 // 0x0028   (0x0050)  
	...
	SDK_UNDEFINED(80,1196) /* TSet<URCAction*> */      __um(Actions);                                              // 0x0098   (0x0050)  
};
...
public:
	...
	// void OnPassed(class URCBehaviour* InBehaviour);                                                                          // [0x4d8ca40] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourBindNode.IsSupported
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x719fa70] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourBindNode.Execute
	// bool Execute(class URCBehaviour* InBehaviour);                                                                           // [0x719f9d0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void PreExecute(class URCBehaviour* InBehaviour);                                                                        // [0x719fc50] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	...
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x719fb10] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
...
public:
	...
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x719fbb0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourOnValueChangedNode.Execute
	// bool Execute(class URCBehaviour* InBehaviour);                                                                           // [0x719fa70] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(80,1197) /* TSet<URCBehaviour*> */   __um(Behaviours);                                           // 0x00E0   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,1198) /* TSet<URCActionContainer*> */ __um(SharedActionContainers);                           // 0x0108   (0x0050)  
};
...
public:
	...
	// void TestIntFunction();                                                                                                  // [0x719fce0] Final|Native|Public|BlueprintCallable 
};
