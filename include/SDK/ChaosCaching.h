...
public:
	...
	// void TriggerComponentByCache(FName InCacheName);                                                                         // [0x7deb7e0] Final|RequiredAPI|Native|Protected|BlueprintCallable 
	// Function /Script/ChaosCaching.ChaosCacheManager.TriggerComponent
	// void TriggerComponent(class UPrimitiveComponent* InComponent);                                                           // [0x7deb6c0] Final|RequiredAPI|Native|Protected|BlueprintCallable 
	// Function /Script/ChaosCaching.ChaosCacheManager.TriggerAll
	// void TriggerAll();                                                                                                       // [0x7deb5f0] Final|RequiredAPI|Native|Protected|BlueprintCallable 
	// Function /Script/ChaosCaching.ChaosCacheManager.SetStartTime
	// void SetStartTime(float InStartTime);                                                                                    // [0x7deb560] Final|RequiredAPI|Native|Public 
	// Function /Script/ChaosCaching.ChaosCacheManager.SetCurrentTime
	// void SetCurrentTime(float CurrentTime);                                                                                  // [0x7deb560] Final|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCaching.ChaosCacheManager.SetCacheCollection
	// void SetCacheCollection(class UChaosCacheCollection* InCacheCollection);                                                 // [0x7deb490] Final|RequiredAPI|Native|Protected|BlueprintCallable 
	// Function /Script/ChaosCaching.ChaosCacheManager.ResetSingleTransform
	// void ResetSingleTransform(int32_t InIndex);                                                                              // [0x7deb390] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCaching.ChaosCacheManager.ResetAllComponentTransforms
	// void ResetAllComponentTransforms();                                                                                      // [0x7deb240] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCaching.ChaosCacheManager.EnablePlaybackByCache
	// void EnablePlaybackByCache(FName InCacheName, bool bEnable);                                                             // [0x7deb130] Final|RequiredAPI|Native|Protected|BlueprintCallable 
	// Function /Script/ChaosCaching.ChaosCacheManager.EnablePlayback
	// void EnablePlayback(int32_t Index, bool bEnable);                                                                        // [0x7deb040] Final|RequiredAPI|Native|Protected|BlueprintCallable 
};
