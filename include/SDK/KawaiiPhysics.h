...
public:
	...
	// FKawaiiPhysicsReference SetWindScale(FKawaiiPhysicsReference& KawaiiPhysics, float WindScale);                           // [0x7d2db10] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.SetTeleportRotationThreshold
	// FKawaiiPhysicsReference SetTeleportRotationThreshold(FKawaiiPhysicsReference& KawaiiPhysics, float TeleportRotationThreshold); // [0x7d2da10] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.SetTeleportDistanceThreshold
	// FKawaiiPhysicsReference SetTeleportDistanceThreshold(FKawaiiPhysicsReference& KawaiiPhysics, float TeleportDistanceThreshold); // [0x7d2d910] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.SetPhysicsSettings
	// FKawaiiPhysicsReference SetPhysicsSettings(FKawaiiPhysicsReference& KawaiiPhysics, FKawaiiPhysicsSettings& PhysicsSettings); // [0x7d2d7f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.SetNeedWarmUp
	// FKawaiiPhysicsReference SetNeedWarmUp(FKawaiiPhysicsReference& KawaiiPhysics, bool NeedWarmUp);                          // [0x7d2d6f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.SetGravity
	// FKawaiiPhysicsReference SetGravity(FKawaiiPhysicsReference& KawaiiPhysics, FVector Gravity);                             // [0x7d2d5e0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.SetEnableWind
	// FKawaiiPhysicsReference SetEnableWind(FKawaiiPhysicsReference& KawaiiPhysics, bool EnableWind);                          // [0x7d2d4e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.SetDummyBoneLength
	// FKawaiiPhysicsReference SetDummyBoneLength(FKawaiiPhysicsReference& KawaiiPhysics, float DummyBoneLength);               // [0x7d2d3e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.SetAllowWorldCollision
	// FKawaiiPhysicsReference SetAllowWorldCollision(FKawaiiPhysicsReference& KawaiiPhysics, bool AllowWorldCollision);        // [0x7d2d2e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.ResetDynamics
	// FKawaiiPhysicsReference ResetDynamics(FKawaiiPhysicsReference& KawaiiPhysics);                                           // [0x7d2d240] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetWindScale
	// float GetWindScale(FKawaiiPhysicsReference& KawaiiPhysics);                                                              // [0x7d2d1a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetTeleportRotationThreshold
	// float GetTeleportRotationThreshold(FKawaiiPhysicsReference& KawaiiPhysics);                                              // [0x7d2d100] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetTeleportDistanceThreshold
	// float GetTeleportDistanceThreshold(FKawaiiPhysicsReference& KawaiiPhysics);                                              // [0x7d2d060] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetPhysicsSettings
	// FKawaiiPhysicsSettings GetPhysicsSettings(FKawaiiPhysicsReference& KawaiiPhysics);                                       // [0x7d2cfb0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetNeedWarmUp
	// bool GetNeedWarmUp(FKawaiiPhysicsReference& KawaiiPhysics);                                                              // [0x7d2cf10] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetGravity
	// FVector GetGravity(FKawaiiPhysicsReference& KawaiiPhysics);                                                              // [0x7d2ce60] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetEnableWind
	// bool GetEnableWind(FKawaiiPhysicsReference& KawaiiPhysics);                                                              // [0x7d2cdc0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetDummyBoneLength
	// float GetDummyBoneLength(FKawaiiPhysicsReference& KawaiiPhysics);                                                        // [0x7d2cd20] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.GetAllowWorldCollision
	// bool GetAllowWorldCollision(FKawaiiPhysicsReference& KawaiiPhysics);                                                     // [0x7d2cc80] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.ConvertToKawaiiPhysicsPure
	// void ConvertToKawaiiPhysicsPure(FAnimNodeReference& Node, FKawaiiPhysicsReference& KawaiiPhysics, bool& Result);         // [0x7d2cb10] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/KawaiiPhysics.KawaiiPhysicsLibrary.ConvertToKawaiiPhysics
	// FKawaiiPhysicsReference ConvertToKawaiiPhysics(FAnimNodeReference& Node, EAnimNodeReferenceConversionResult& Result);    // [0x7d2ca10] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
