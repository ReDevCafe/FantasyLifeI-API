...
public:
	...
	// void OnOutputFrameStarted(class UMoviePipeline* ForPipeline);                                                            // [0x2f06970] Event|Public|BlueprintEvent 
};
...
{ 
public:
	SDK_UNDEFINED(16,1138) /* TArray<TScriptInterface<Class>> */ __um(ConsoleVariablePresets);                     // 0x0048   (0x0010)  
	...
	// bool UpdateConsoleVariableEnableState(FString Name, bool bIsEnabled);                                                    // [0x7664750] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineSettings.MoviePipelineConsoleVariableSetting.RemoveConsoleVariable
	// bool RemoveConsoleVariable(FString Name, bool bRemoveAllInstances);                                                      // [0x76645f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineSettings.MoviePipelineConsoleVariableSetting.GetConsoleVariables
	// TArray<FMoviePipelineConsoleVariableEntry> GetConsoleVariables();                                                        // [0x7664450] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineSettings.MoviePipelineConsoleVariableSetting.AddOrUpdateConsoleVariable
	// bool AddOrUpdateConsoleVariable(FString Name, float Value);                                                              // [0x7664270] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineSettings.MoviePipelineConsoleVariableSetting.AddConsoleVariable
	// bool AddConsoleVariable(FString Name, float Value);                                                                      // [0x76640d0] Final|Native|Public|BlueprintCallable 
};
