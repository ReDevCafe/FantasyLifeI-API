...
public:
	...
	// void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x7944780] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	// void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x7944590] Final|Native|Public  
};
...
public:
	...
	SDK_UNDEFINED(16,1072) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,1073) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00E0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,1074) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,1075) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x0120   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x88];                                      // 0x0048   (0x0088)  MISSED
	SDK_UNDEFINED(16,1076) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,1077) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00E0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,1079) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x0058   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,1080) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1081) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x0058   (0x0010)  
	float                                              ScaleMultiplier;                                            // 0x0068   (0x0004)  
...
public:
	...
	SDK_UNDEFINED(16,1082) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,1083) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,1084) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1085) /* TScriptInterface<Class> */ __um(AngleSource);                                        // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,1086) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,1087) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0078   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,1088) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1089) /* TScriptInterface<Class> */ __um(ParameterSource);                                    // 0x0058   (0x0010)  
	class UGizmoViewContext*                           GizmoViewContext;                                           // 0x0068   (0x0008)  
	SDK_UNDEFINED(16,1090) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,1091) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0080   (0x0010)  
...
public:
	...
	// void SetTransform(FTransform& NewTransform);                                                                             // [0x7944250] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoTransformSource.GetTransform
	// FTransform GetTransform();                                                                                               // [0x7944080] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// bool HasTangentVectors();                                                                                                // [0x7944110] Native|Public|Const  
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors
	// void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut);                                                      // [0x7943f90] Native|Public|HasOutParms|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetOrigin
	// FVector GetOrigin();                                                                                                     // [0x7943ee0] Native|Public|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetDirection
	// FVector GetDirection();                                                                                                  // [0x7943ea0] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// void UpdateInteractingState(bool bInteracting);                                                                          // [0x79446f0] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState
	// void UpdateHoverState(bool bHovering);                                                                                   // [0x7944500] Native|Public        
};
...
public:
	...
	// void UpdateInteractingState(bool bInteracting, uint32_t InPartIdentifier);                                               // [0x7944620] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickMultiTarget.UpdateHoverState
	// void UpdateHoverState(bool bHovering, uint32_t InPartIdentifier);                                                        // [0x7944430] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickMultiTarget.UpdateHittableState
	// void UpdateHittableState(bool bHittable, uint32_t InPartIdentifier);                                                     // [0x7944360] Native|Public        
};
...
public:
	...
	// void UpdateVisibilityState(bool bVisible, uint32_t InPartIdentifier);                                                    // [0x7944430] Native|Public        
};
...
public:
	...
	// void EndUpdate();                                                                                                        // [0x7943e60] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoStateTarget.BeginUpdate
	// void BeginUpdate();                                                                                                      // [0x3b8ebc0] Native|Public        
};
...
public:
	...
	// void SetParameter(FVector2D& NewValue);                                                                                  // [0x79441c0] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter
	// FVector2D GetParameter();                                                                                                // [0x7943f50] Native|Public|HasDefaults|Const 
...
{ 
public:
	SDK_UNDEFINED(16,1092) /* TScriptInterface<Class> */ __um(FloatParameterSource);                               // 0x0048   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,1093) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1094) /* TScriptInterface<Class> */ __um(ParameterSource);                                    // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,1095) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,1096) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0078   (0x0010)  
	class UClickDragInputBehavior*                     MouseBehavior;                                              // 0x0088   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,1097) /* TScriptInterface<Class> */ __um(TransactionManager);                                 // 0x0048   (0x0010)  
};
...
public:
	unsigned char                                      UnknownData00_8[0x20];                                      // 0x0028   (0x0020)  MISSED
	SDK_UNDEFINED(16,1098) /* TScriptInterface<Class> */ __um(TransactionManager);                                 // 0x0048   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,1099) /* TScriptInterface<Class> */ __um(ChildTransformSource);                               // 0x0048   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,1100) /* TScriptInterface<Class> */ __um(ScaledTransformSource);                              // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1101) /* TScriptInterface<Class> */ __um(UnscaledTransformSource);                            // 0x0058   (0x0010)  
};
