...
{ 
public:
	SDK_UNDEFINED(16,683) /* FMulticastInlineDelegate */ __um(OnInstanceTakePointDamage);                          // 0x0B10   (0x0010)  
	SDK_UNDEFINED(16,684) /* FMulticastInlineDelegate */ __um(OnInstanceTakeRadialDamage);                         // 0x0B20   (0x0010)  
...
public:
	...
	// int32_t FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // [0x473b9e0] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxTransforms
	// void FoliageOverlappingBoxTransforms(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box, TArray<FTransform>& OutTransforms); // [0x473b850] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	// int32_t FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box);          // [0x473b6f0] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x473b360] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	SDK_UNDEFINED(16,685) /* TArray<TWeakObjectPtr<UMaterialInterface*>> */ __um(OverrideFoliageTerrainMaterials); // 0x0058   (0x0010)  
	unsigned char                                      UnknownData02_7[0x18];                                      // 0x0068   (0x0018)  MISSED


	/// Functions
	// Function /Script/Foliage.ProceduralFoliageSpawner.Simulate
	// void Simulate(int32_t NumSteps);                                                                                         // [0x473bb60] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
