...
{ 
public:
	SDK_UNDEFINED(80,670) /* TSet<FName> */            __um(Layers);                                               // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,671) /* TSet<FName> */            __um(Tags);                                                 // 0x0080   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,672) /* TMap<FName, TWeakObjectPtr<UTexture*>> */ __um(TextureParameterValues);               // 0x00F8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,673) /* TMap<FName, TWeakObjectPtr<AActor*>> */ __um(RelatedActors);                          // 0x0298   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,674) /* TSet<FName> */            __um(Tags);                                                 // 0x00C8   (0x0050)  
