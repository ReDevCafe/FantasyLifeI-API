...
public:
	...
	// void TogglePromotePropertyToPin(FName& PropertyName);                                                                    // [0x75cd510] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphNode.GetOutputPin
	// class UMovieGraphPin* GetOutputPin(FName& InPinLabel);                                                                   // [0x75ccc90] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphNode.GetInputPin
	// class UMovieGraphPin* GetInputPin(FName& InPinLabel, EMovieGraphPinQueryRequirement PinRequirement);                     // [0x75cca60] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphNode.GetExposedProperties
	// TArray<FMovieGraphPropertyInfo> GetExposedProperties();                                                                  // [0x59b6a30] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,1122) /* TScriptInterface<Class> */ __um(ConsoleVariablePreset);                              // 0x00A0   (0x0010)  
};
...
public:
	...
	// int32_t ResolveVersionNumber(FMovieGraphFilenameResolveParams InParams, bool bGetNextVersion);                           // [0x75c7d20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.ResolveFilenameFormatArguments
	// FString ResolveFilenameFormatArguments(FString InFormatString, FMovieGraphFilenameResolveParams& InParams, FMovieGraphResolveArgs& OutMergedFormatArgs); // [0x75c7a90] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.NamedResolutionFromSize
	// FMovieGraphNamedResolution NamedResolutionFromSize(int32_t InResX, int32_t InResY);                                      // [0x75c7370] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.NamedResolutionFromProfile
	// FMovieGraphNamedResolution NamedResolutionFromProfile(FName& InResolutionProfileName);                                   // [0x75c72c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.IsNamedResolutionValid
	// bool IsNamedResolutionValid(FName& InResolutionProfileName);                                                             // [0x75c7220] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetRootTimecode
	// FTimecode GetRootTimecode(class UMovieGraphPipeline* InMovieGraphPipeline);                                              // [0x75c6d10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetRootFrameNumber
	// FFrameNumber GetRootFrameNumber(class UMovieGraphPipeline* InMovieGraphPipeline);                                        // [0x75c6c80] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetPipelineState
	// EMovieRenderPipelineState GetPipelineState(class UMovieGraphPipeline* InMovieGraphPipeline);                             // [0x75c6bf0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetOverallSegmentCounts
	// void GetOverallSegmentCounts(class UMovieGraphPipeline* InMovieGraphPipeline, int32_t& OutCurrentIndex, int32_t& OutTotalCount); // [0x75c6ac0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetOverallOutputFrames
	// void GetOverallOutputFrames(class UMovieGraphPipeline* InMovieGraphPipeline, int32_t& OutCurrentIndex, int32_t& OutTotalCount); // [0x75c6990] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetJobName
	// FText GetJobName(class UMovieGraphPipeline* InMovieGraphPipeline);                                                       // [0x75c67a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetJobInitializationTime
	// FDateTime GetJobInitializationTime(class UMovieGraphPipeline* InMovieGraphPipeline);                                     // [0x75c6710] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetJobAuthor
	// FText GetJobAuthor(class UMovieGraphPipeline* InMovieGraphPipeline);                                                     // [0x75c6660] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetEstimatedTimeRemaining
	// bool GetEstimatedTimeRemaining(class UMovieGraphPipeline* InMovieGraphPipeline, FTimespan& OutEstimate);                 // [0x75c64c0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetEffectiveOutputResolution
	// FIntPoint GetEffectiveOutputResolution(class UMovieGraphEvaluatedConfig* InEvaluatedGraph);                              // [0x75c6430] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetEffectiveFrameRate
	// FFrameRate GetEffectiveFrameRate(class UMovieGraphGlobalOutputSettingNode* InNode, FFrameRate& InDefaultRate);           // [0x75c6350] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentShotTimecode
	// FTimecode GetCurrentShotTimecode(class UMovieGraphPipeline* InMovieGraphPipeline);                                       // [0x75c62b0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentShotFrameNumber
	// FFrameNumber GetCurrentShotFrameNumber(class UMovieGraphPipeline* InMovieGraphPipeline);                                 // [0x75c6220] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentSegmentWorkMetrics
	// FMoviePipelineSegmentWorkMetrics GetCurrentSegmentWorkMetrics(class UMovieGraphPipeline* InMovieGraphPipeline);          // [0x75c6130] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentSegmentState
	// EMovieRenderShotState GetCurrentSegmentState(class UMovieGraphPipeline* InMovieGraphPipeline);                           // [0x75c60a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentSegmentName
	// void GetCurrentSegmentName(class UMovieGraphPipeline* InMovieGraphPipeline, FText& OutOuterName, FText& OutInnerName);   // [0x75c5f50] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentFocusDistance
	// float GetCurrentFocusDistance(class UMovieGraphPipeline* InMovieGraphPipeline);                                          // [0x75c5ec0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentFocalLength
	// float GetCurrentFocalLength(class UMovieGraphPipeline* InMovieGraphPipeline);                                            // [0x75c5e30] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentCineCamera
	// class UCineCameraComponent* GetCurrentCineCamera(class UMovieGraphPipeline* InMovieGraphPipeline);                       // [0x75c5da0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentAperture
	// float GetCurrentAperture(class UMovieGraphPipeline* InMovieGraphPipeline);                                               // [0x75c5d10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCompletionPercentage
	// float GetCompletionPercentage(class UMovieGraphPipeline* InPipeline);                                                    // [0x75c5c80] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void UpdateForGraph(class UMovieGraphPipeline* InGraphPipeline, class UMovieGraphEvaluatedConfig* InEvaluatedConfig);    // [0x2f06970] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void SetValueTypeObject(class UObject* ValueTypeObject);                                                                 // [0x75d8a80] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueType
	// void SetValueType(EMovieGraphValueType valueType, class UObject* InValueTypeObject);                                     // [0x75d89b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueText
	// bool SetValueText(FText& InValue);                                                                                       // [0x75d87f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueString
	// bool SetValueString(FString InValue);                                                                                    // [0x75d8650] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueSerializedString
	// bool SetValueSerializedString(FString NewValue);                                                                         // [0x75d84b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueObject
	// bool SetValueObject(class UObject* InValue);                                                                             // [0x75d79d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueName
	// bool SetValueName(FName InValue);                                                                                        // [0x75d8340] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueInt64
	// bool SetValueInt64(int64_t InValue);                                                                                     // [0x75d81d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueInt32
	// bool SetValueInt32(int32_t InValue);                                                                                     // [0x75d8060] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueFloat
	// bool SetValueFloat(float InValue);                                                                                       // [0x75d7f00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueEnum
	// bool SetValueEnum(char InValue, class UEnum* Enum);                                                                      // [0x75d7d20] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueDouble
	// bool SetValueDouble(double InValue);                                                                                     // [0x75d7bc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueContainerType
	// void SetValueContainerType(EMovieGraphContainerType ContainerType);                                                      // [0x75d7b40] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueClass
	// bool SetValueClass(class UClass* InValue);                                                                               // [0x75d79d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueByte
	// bool SetValueByte(char InValue);                                                                                         // [0x75d7870] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueBool
	// bool SetValueBool(bool bInValue);                                                                                        // [0x75d7700] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueTypeObject
	// class UObject* GetValueTypeObject();                                                                                     // [0x75d73b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueType
	// EMovieGraphValueType GetValueType();                                                                                     // [0x75d72e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueText
	// bool GetValueText(FText& OutValue);                                                                                      // [0x75d7120] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueString
	// bool GetValueString(FString& OutValue);                                                                                  // [0x75d6f60] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueSerializedString
	// FString GetValueSerializedString();                                                                                      // [0x75d6e00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueObject
	// bool GetValueObject(class UObject* OutValue, class UClass* RequestedClass);                                              // [0x75d6c20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueName
	// bool GetValueName(FName& OutValue);                                                                                      // [0x75d6a90] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueInt64
	// bool GetValueInt64(int64_t& OutValue);                                                                                   // [0x75d6900] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueInt32
	// bool GetValueInt32(int32_t& OutValue);                                                                                   // [0x75d6770] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueFloat
	// bool GetValueFloat(float& OutValue);                                                                                     // [0x75d65e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueEnum
	// bool GetValueEnum(char& OutValue, class UEnum* RequestedEnum);                                                           // [0x75d63d0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueDouble
	// bool GetValueDouble(double& OutValue);                                                                                   // [0x75d6240] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueContainerType
	// EMovieGraphContainerType GetValueContainerType();                                                                        // [0x75d6170] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueClass
	// bool GetValueClass(class UClass*& OutValue);                                                                             // [0x75d5fe0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueByte
	// bool GetValueByte(char& OutValue);                                                                                       // [0x75d5e50] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueBool
	// bool GetValueBool(bool& bOutValue);                                                                                      // [0x75d5cc0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool SetMemberName(FString InNewName);                                                                                   // [0x75c7e40] Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphMember.GetMemberName
	// FString GetMemberName();                                                                                                 // [0x75c6850] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphMember.GetGuid
	// FGuid GetGuid();                                                                                                         // [0x75c65a0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TArray<UMovieGraphSettingNode*> GetSettingsForBranch(class UClass* InClass, FName InBranchName, bool bIncludeCDOs, bool bExactMatch); // [0x75c6f70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphEvaluatedConfig.GetSettingForBranch
	// class UMovieGraphSettingNode* GetSettingForBranch(class UClass* InClass, FName InBranchName, bool bIncludeCDOs, bool bExactMatch); // [0x75c6db0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphEvaluatedConfig.GetBranchNames
	// TArray<FName> GetBranchNames();                                                                                          // [0x75c5bc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateGlobalVariableValues(class UMovieGraphPipeline* InPipeline);                                                  // [0x75c7ef0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveOutboundEdges
	// bool RemoveOutboundEdges(class UMovieGraphNode* InNode, FName& InPinName);                                               // [0x75c79b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveNodes
	// bool RemoveNodes(TArray<UMovieGraphNode*> InNodes);                                                                      // [0x75c78b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveNode
	// bool RemoveNode(class UMovieGraphNode* InNode);                                                                          // [0x75c7810] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveLabeledEdge
	// bool RemoveLabeledEdge(class UMovieGraphNode* FromNode, FName& FromPinName, class UMovieGraphNode* ToNode, FName& ToPinName); // [0x75c7680] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveInboundEdges
	// bool RemoveInboundEdges(class UMovieGraphNode* InNode, FName& InPinName);                                                // [0x75c75a0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveAllOutboundEdges
	// bool RemoveAllOutboundEdges(class UMovieGraphNode* InNode);                                                              // [0x75c7500] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveAllInboundEdges
	// bool RemoveAllInboundEdges(class UMovieGraphNode* InNode);                                                               // [0x75c7460] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetVariables
	// TArray<UMovieGraphVariable*> GetVariables(bool bIncludeGlobal);                                                          // [0x75c7140] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetOutputs
	// TArray<UMovieGraphOutput*> GetOutputs();                                                                                 // [0x75c6910] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetOutputNode
	// class UMovieGraphNode* GetOutputNode();                                                                                  // [0x48ceb40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetInputs
	// TArray<UMovieGraphInput*> GetInputs();                                                                                   // [0x75c65e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetInputNode
	// class UMovieGraphNode* GetInputNode();                                                                                   // [0x75c65c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.DeleteMember
	// bool DeleteMember(class UMovieGraphMember* MemberToDelete);                                                              // [0x75c5b20] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.CreateNodeByClass
	// class UMovieGraphNode* CreateNodeByClass(class UClass* InClass);                                                         // [0x75c58e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.CreateFlattenedGraph
	// class UMovieGraphEvaluatedConfig* CreateFlattenedGraph(FMovieGraphTraversalContext& InContext, FString& OutError);       // [0x75c5720] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.AddVariable
	// class UMovieGraphVariable* AddVariable(FName InCustomBaseName);                                                          // [0x75c5680] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.AddOutput
	// class UMovieGraphOutput* AddOutput();                                                                                    // [0x75c5650] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.AddLabeledEdge
	// bool AddLabeledEdge(class UMovieGraphNode* FromNode, FName& FromPinLabel, class UMovieGraphNode* ToNode, FName& ToPinLabel); // [0x75c54c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.AddInput
	// class UMovieGraphInput* AddInput();                                                                                      // [0x75c5490] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FMovieGraphTimeStepData GetCalculatedTimeData();                                                                         // [0x75cc8e0] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TArray<FMovieGraphImagePreviewData> GetPreviewData();                                                                    // [0x75ccd40] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnShotStart(class UMoviePipelineExecutorJob* InJobCopy, class UMoviePipelineExecutorShot* InShotCopy);              // [0x75cd2e0] Native|Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MovieGraphScriptBase.OnShotFinished
	// void OnShotFinished(class UMoviePipelineExecutorJob* InJobCopy, class UMoviePipelineExecutorShot* InShotCopy, FMoviePipelineOutputData& OutputData); // [0x75cd0e0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MovieGraphScriptBase.OnJobStart
	// void OnJobStart(class UMoviePipelineExecutorJob* InJobCopy);                                                             // [0x75cd050] Native|Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MovieGraphScriptBase.OnJobFinished
	// void OnJobFinished(class UMoviePipelineExecutorJob* InJobCopy, FMoviePipelineOutputData& InOutputData);                  // [0x75cce80] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MovieGraphScriptBase.IsPerShotCallbackNeeded
	// bool IsPerShotCallbackNeeded();                                                                                          // [0x4d8cd20] Native|Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// bool RemoveModifier(class UClass* ModifierType);                                                                         // [0x75cd460] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.RemoveCollection
	// bool RemoveCollection(FName& InCollectionName);                                                                          // [0x75cd3b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.GetModifiers
	// TArray<UMovieGraphCollectionModifier*> GetModifiers();                                                                   // [0x75ccc00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.GetModifier
	// class UMovieGraphCollectionModifier* GetModifier(class UClass* ModifierType);                                            // [0x75ccb50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.GetCollections
	// TArray<FName> GetCollections();                                                                                          // [0x75cc9d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.AddModifier
	// class UMovieGraphCollectionModifier* AddModifier(class UClass* ModifierType);                                            // [0x75cc830] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.AddCollection
	// void AddCollection(FName& InCollectionName);                                                                             // [0x75cc790] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// TArray<UMovieGraphNode*> GetConnectedNodes();                                                                            // [0x75d2050] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	SDK_UNDEFINED(16,1123) /* FMulticastInlineDelegate */ __um(OnMoviePipelineWorkFinishedDelegate);               // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,1124) /* FMulticastInlineDelegate */ __um(OnMoviePipelineShotWorkFinishedDelegate);           // 0x0038   (0x0010)  
	...
	// void Shutdown(bool bIsError);                                                                                            // [0x4c6b780] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBase.RequestShutdown
	// void RequestShutdown(bool bIsError);                                                                                     // [0x5301780] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBase.IsShutdownRequested
	// bool IsShutdownRequested();                                                                                              // [0x5302010] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBase.GetPipelineState
	// EMovieRenderPipelineState GetPipelineState();                                                                            // [0x4c65b30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(80,1125) /* TSet<UMovieGraphFileOutputNode*> */ __um(OutputNodesDataSentTo);                     // 0x00F8   (0x0050)  
	...
	// void SetInitializationTime(FDateTime& InDateTime);                                                                       // [0x75d2f20] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.OnMoviePipelineFinishedImpl
	// void OnMoviePipelineFinishedImpl();                                                                                      // [0x509e7a0] Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.Initialize
	// void Initialize(class UMoviePipelineExecutorJob* InJob, FMovieGraphInitConfig& InitConfig);                              // [0x75d24e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetTimeStepInstance
	// class UMovieGraphTimeStepBase* GetTimeStepInstance();                                                                    // [0x75d24b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetRendererInstance
	// class UMovieGraphRendererBase* GetRendererInstance();                                                                    // [0x75d2490] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetInitializationTimeOffset
	// FTimespan GetInitializationTimeOffset();                                                                                 // [0x5119200] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetInitializationTime
	// FDateTime GetInitializationTime();                                                                                       // [0x50d45a0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetCurrentTraversalContext
	// FMovieGraphTraversalContext GetCurrentTraversalContext(bool bForShot);                                                   // [0x75d20d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetCurrentJob
	// class UMoviePipelineExecutorJob* GetCurrentJob();                                                                        // [0x55fe340] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool ShouldHidePropertyNames();                                                                                          // [0x4d71ed0] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.SetOperationType
	// void SetOperationType(EMovieGraphConditionGroupQueryOpType OperationType);                                               // [0x75d3180] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.SetEnabled
	// void SetEnabled(bool bEnabled);                                                                                          // [0x75d2e00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.IsFirstConditionGroupQuery
	// bool IsFirstConditionGroupQuery();                                                                                       // [0x75d2620] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.IsEnabled
	// bool IsEnabled();                                                                                                        // [0x75d25c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.IsEditorOnlyQuery
	// bool IsEditorOnlyQuery();                                                                                                // [0x4d8cd20] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.GetOperationType
	// EMovieGraphConditionGroupQueryOpType GetOperationType();                                                                 // [0x75d2340] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.Evaluate
	// void Evaluate(TArray<AActor*>& InActorsToQuery, class UWorld* InWorld, TSet<AActor*>& OutMatchingActors);                // [0x75d1c10] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	SDK_UNDEFINED(16,1126) /* TArray<TWeakObjectPtr<AActor*>> */ __um(ActorsToMatch);                              // 0x0030   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,1127) /* TArray<TWeakObjectPtr<UWorld*>> */ __um(Sublevels);                                  // 0x0030   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(80,1128) /* TSet<AActor*> */         __um(QueryResult);                                          // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,1129) /* TSet<AActor*> */         __um(EvaluationResult);                                     // 0x00A0   (0x0050)  


	/// Functions
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.SetOperationType
	// void SetOperationType(EMovieGraphConditionGroupOpType OperationType);                                                    // [0x75d3100] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.RemoveQuery
	// bool RemoveQuery(class UMovieGraphConditionGroupQueryBase* InQuery);                                                     // [0x75d2950] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.MoveQueryToIndex
	// bool MoveQueryToIndex(class UMovieGraphConditionGroupQueryBase* InQuery, int32_t NewIndex);                              // [0x75d2750] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.IsFirstConditionGroup
	// bool IsFirstConditionGroup();                                                                                            // [0x75d25f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.GetQueries
	// TArray<UMovieGraphConditionGroupQueryBase*> GetQueries();                                                                // [0x75d2370] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.GetOperationType
	// EMovieGraphConditionGroupOpType GetOperationType();                                                                      // [0x75d2310] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.Evaluate
	// TSet<AActor*> Evaluate(class UWorld* InWorld);                                                                           // [0x75d1af0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.AddQuery
	// class UMovieGraphConditionGroupQueryBase* AddQuery(class UClass*& InQueryType, int32_t InsertIndex);                     // [0x75d1790] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetCollectionName(FString InName);                                                                                  // [0x75d2c00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.RemoveConditionGroup
	// bool RemoveConditionGroup(class UMovieGraphConditionGroup* InConditionGroup);                                            // [0x75d2820] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.MoveConditionGroupToIndex
	// bool MoveConditionGroupToIndex(class UMovieGraphConditionGroup* InConditionGroup, int32_t NewIndex);                     // [0x75d2680] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.GetConditionGroups
	// TArray<UMovieGraphConditionGroup*> GetConditionGroups();                                                                 // [0x75d1fc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.GetCollectionName
	// FString GetCollectionName();                                                                                             // [0x75d1ec0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.Evaluate
	// TSet<AActor*> Evaluate(class UWorld* InWorld);                                                                           // [0x75d19d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.AddConditionGroup
	// class UMovieGraphConditionGroup* AddConditionGroup();                                                                    // [0x75d16d0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetCollections(TArray<UMovieGraphCollection*> InCollections);                                                       // [0x75d2ca0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollectionModifier.GetCollections
	// TArray<UMovieGraphCollection*> GetCollections();                                                                         // [0x75d1f00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollectionModifier.AddCollection
	// void AddCollection(class UMovieGraphCollection* Collection);                                                             // [0x75d1640] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void UndoModifier();                                                                                                     // [0x4d8d160] Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphMaterialModifier.SetMaterial
	// void SetMaterial(TWeakObjectPtr<UMaterialInterface*> InMaterial);                                                        // [0x75d2fc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphMaterialModifier.ApplyModifier
	// void ApplyModifier(class UWorld* World);                                                                                 // [0x75cd050] Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetHidden(bool bInIsHidden);                                                                                        // [0x75d2e90] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderPropertyModifier.IsHidden
	// bool IsHidden();                                                                                                         // [0x75d2650] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
...
public:
	...
	// void SetRenderLayerName(FName& NewName);                                                                                 // [0x75d3200] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.Revert
	// void Revert();                                                                                                           // [0x75d2ab0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.RemoveModifier
	// void RemoveModifier(class UMovieGraphCollectionModifier* Modifier);                                                      // [0x75d28c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.GetRenderLayerName
	// FName GetRenderLayerName();                                                                                              // [0x59b67e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.GetModifiers
	// TArray<UMovieGraphCollectionModifier*> GetModifiers();                                                                   // [0x75d2250] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.GetCollectionByName
	// class UMovieGraphCollection* GetCollectionByName(FString Name);                                                          // [0x75d1e10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.Apply
	// void Apply(class UWorld* World);                                                                                         // [0x75d1920] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.AddModifier
	// void AddModifier(class UMovieGraphCollectionModifier* Modifier);                                                         // [0x75d1700] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetActiveRenderLayerByObj(class UMovieGraphRenderLayer* RenderLayer);                                               // [0x75d2b70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.SetActiveRenderLayerByName
	// void SetActiveRenderLayerByName(FName& RenderLayerName);                                                                 // [0x75d2ad0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.Reset
	// void Reset();                                                                                                            // [0x75d2a90] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.RemoveRenderLayer
	// void RemoveRenderLayer(FString RenderLayerName);                                                                         // [0x75d29f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.GetRenderLayers
	// TArray<UMovieGraphRenderLayer*> GetRenderLayers();                                                                       // [0x75d2400] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.GetFromWorld
	// class UMovieGraphRenderLayerSubsystem* GetFromWorld(class UWorld* World);                                                // [0x75d21c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.GetActiveRenderLayer
	// class UMovieGraphRenderLayer* GetActiveRenderLayer();                                                                    // [0x48ceb40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.ClearActiveRenderLayer
	// void ClearActiveRenderLayer();                                                                                           // [0x75d19b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.AddRenderLayer
	// bool AddRenderLayer(class UMovieGraphRenderLayer* RenderLayer);                                                          // [0x75d1880] Final|Native|Public|BlueprintCallable 
};
...
public:
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0028   (0x0008)  MISSED
	SDK_UNDEFINED(80,1130) /* TSet<uint32_t> */        __um(OverriddenShowFlags);                                  // 0x0030   (0x0050)  
...
public:
	...
	// void SetSubGraphAsset(TWeakObjectPtr<UMovieGraphConfig*>& InSubgraphAsset);                                              // [0x75d7630] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphSubgraphNode.GetSubgraphAsset
	// class UMovieGraphConfig* GetSubgraphAsset();                                                                             // [0x75d5c90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetVariable(class UMovieGraphVariable* InVariable);                                                                 // [0x75d8b10] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphVariableNode.GetVariable
	// class UMovieGraphVariable* GetVariable();                                                                                // [0x75d2490] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool SetVariableAssignmentEnableState(class UMovieGraphVariable* InGraphVariable, bool bIsEnabled);                      // [0x75d8ba0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueText
	// bool SetValueText(class UMovieGraphVariable* InGraphVariable, FText& InValue);                                           // [0x75d88b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueString
	// bool SetValueString(class UMovieGraphVariable* InGraphVariable, FString InValue);                                        // [0x75d8700] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueSerializedString
	// bool SetValueSerializedString(class UMovieGraphVariable* InGraphVariable, FString NewValue);                             // [0x75d8560] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueObject
	// bool SetValueObject(class UMovieGraphVariable* InGraphVariable, class UObject* InValue);                                 // [0x75d7a70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueName
	// bool SetValueName(class UMovieGraphVariable* InGraphVariable, FName InValue);                                            // [0x75d83e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueInt64
	// bool SetValueInt64(class UMovieGraphVariable* InGraphVariable, int64_t InValue);                                         // [0x75d8270] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueInt32
	// bool SetValueInt32(class UMovieGraphVariable* InGraphVariable, int32_t InValue);                                         // [0x75d8100] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueFloat
	// bool SetValueFloat(class UMovieGraphVariable* InGraphVariable, float InValue);                                           // [0x75d7f90] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueEnum
	// bool SetValueEnum(class UMovieGraphVariable* InGraphVariable, char InValue, class UEnum* Enum);                          // [0x75d7df0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueDouble
	// bool SetValueDouble(class UMovieGraphVariable* InGraphVariable, double InValue);                                         // [0x75d7c50] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueClass
	// bool SetValueClass(class UMovieGraphVariable* InGraphVariable, class UClass* InValue);                                   // [0x75d7a70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueByte
	// bool SetValueByte(class UMovieGraphVariable* InGraphVariable, char InValue);                                             // [0x75d7900] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueBool
	// bool SetValueBool(class UMovieGraphVariable* InGraphVariable, bool bInValue);                                            // [0x75d77a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetGraphConfig
	// void SetGraphConfig(TWeakObjectPtr<UMovieGraphConfig*>& InGraphConfig);                                                  // [0x75d7560] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetVariableAssignmentEnableState
	// bool GetVariableAssignmentEnableState(class UMovieGraphVariable* InGraphVariable, bool& bOutIsEnabled);                  // [0x75d7480] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueTypeObject
	// class UObject* GetValueTypeObject(class UMovieGraphVariable* InGraphVariable);                                           // [0x75d73e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueType
	// EMovieGraphValueType GetValueType(class UMovieGraphVariable* InGraphVariable);                                           // [0x75d7310] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueText
	// bool GetValueText(class UMovieGraphVariable* InGraphVariable, FText& OutValue);                                          // [0x75d71e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueString
	// bool GetValueString(class UMovieGraphVariable* InGraphVariable, FString& OutValue);                                      // [0x75d7020] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueSerializedString
	// FString GetValueSerializedString(class UMovieGraphVariable* InGraphVariable);                                            // [0x75d6e80] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueObject
	// bool GetValueObject(class UMovieGraphVariable* InGraphVariable, class UObject* OutValue, class UClass* RequestedClass);  // [0x75d6cf0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueName
	// bool GetValueName(class UMovieGraphVariable* InGraphVariable, FName& OutValue);                                          // [0x75d6b40] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueInt64
	// bool GetValueInt64(class UMovieGraphVariable* InGraphVariable, int64_t& OutValue);                                       // [0x75d69b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueInt32
	// bool GetValueInt32(class UMovieGraphVariable* InGraphVariable, int32_t& OutValue);                                       // [0x75d6820] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueFloat
	// bool GetValueFloat(class UMovieGraphVariable* InGraphVariable, float& OutValue);                                         // [0x75d6690] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueEnum
	// bool GetValueEnum(class UMovieGraphVariable* InGraphVariable, char& OutValue, class UEnum* RequestedEnum);               // [0x75d64c0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueDouble
	// bool GetValueDouble(class UMovieGraphVariable* InGraphVariable, double& OutValue);                                       // [0x75d62f0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueContainerType
	// EMovieGraphContainerType GetValueContainerType(class UMovieGraphVariable* InGraphVariable);                              // [0x75d61a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueClass
	// bool GetValueClass(class UMovieGraphVariable* InGraphVariable, class UClass*& OutValue);                                 // [0x75d6090] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueByte
	// bool GetValueByte(class UMovieGraphVariable* InGraphVariable, char& OutValue);                                           // [0x75d5f00] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueBool
	// bool GetValueBool(class UMovieGraphVariable* InGraphVariable, bool& bOutValue);                                          // [0x75d5d70] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetIsEnabled(bool bInEnabled);                                                                                      // [0x765e2b0] Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting.IsEnabled
	// bool IsEnabled();                                                                                                        // [0x4d3d840] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting.BuildNewProcessCommandLineArgs
	// void BuildNewProcessCommandLineArgs(TArray<FString>& InOutUnrealURLParams, TArray<FString>& InOutCommandLineArgs, TArray<FString>& InOutDeviceProfileCvars, TArray<FString>& InOutExecCmds); // [0x765b850] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting.BuildNewProcessCommandLine
	// void BuildNewProcessCommandLine(FString& InOutUnrealURLParams, FString& InOutCommandLineArgs);                           // [0x765b730] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ReceiveTeardownForPipelineImpl(class UMoviePipeline* InPipeline);                                                   // [0x2f06970] Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting_BlueprintBase.ReceiveSetupForPipelineImpl
	// void ReceiveSetupForPipelineImpl(class UMoviePipeline* InPipeline);                                                      // [0x2f06970] Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting_BlueprintBase.ReceiveGetFormatArguments
	// FMoviePipelineFormatArgs ReceiveGetFormatArguments(FMoviePipelineFormatArgs& InOutFormatArgs);                           // [0x75fed00] Native|Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting_BlueprintBase.OnEngineTickBeginFrame
	// void OnEngineTickBeginFrame();                                                                                           // [0x2f06970] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnInitializedForPipeline(class UMoviePipeline* ForPipeline);                                                        // [0x2f06970] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnInitializedForPipeline(class UMovieGraphPipeline* InPipeline);                                                    // [0x2f06970] Event|Public|BlueprintEvent 
};
...
{ 
public:
	SDK_UNDEFINED(16,1131) /* FMulticastInlineDelegate */ __um(OnMoviePipelineFinishedDelegate);                   // 0x0078   (0x0010)  
	...
	// void SetInitializationTime(FDateTime& InDateTime);                                                                       // [0x7633e00] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	...
	// void Initialize(class UMoviePipelineExecutorJob* InJob);                                                                 // [0x7633640] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetPreviewTexture
	// class UTexture* GetPreviewTexture();                                                                                     // [0x55fe340] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetPipelinePrimaryConfig
	// class UMoviePipelinePrimaryConfig* GetPipelinePrimaryConfig();                                                           // [0x7633570] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetPipelineMasterConfig
	// class UMoviePipelinePrimaryConfig* GetPipelineMasterConfig();                                                            // [0x7633570] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetInitializationTimeOffset
	// FTimespan GetInitializationTimeOffset();                                                                                 // [0x7632b30] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetInitializationTime
	// FDateTime GetInitializationTime();                                                                                       // [0x7632b10] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetCurrentJob
	// class UMoviePipelineExecutorJob* GetCurrentJob();                                                                        // [0x7632070] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateJobShotListFromSequence(class ULevelSequence* InSequence, class UMoviePipelineExecutorJob* InJob, bool& bShotsChanged); // [0x7633ea0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.ResolveVersionNumber
	// int32_t ResolveVersionNumber(FMoviePipelineFilenameResolveParams InParams, bool bGetNextVersion);                        // [0x7633b70] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.ResolveFilenameFormatArguments
	// void ResolveFilenameFormatArguments(FString InFormatString, FMoviePipelineFilenameResolveParams& InParams, FString& OutFinalPath, FMoviePipelineFormatArgs& OutMergedFormatArgs); // [0x7633770] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.LoadManifestFileFromString
	// class UMoviePipelineQueue* LoadManifestFileFromString(FString InManifestFilePath);                                       // [0x76336d0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetRootTimecode
	// FTimecode GetRootTimecode(class UMoviePipeline* InMoviePipeline);                                                        // [0x7633030] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetRootFrameNumber
	// FFrameNumber GetRootFrameNumber(class UMoviePipeline* InMoviePipeline);                                                  // [0x7632f20] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetPipelineState
	// EMovieRenderPipelineState GetPipelineState(class UMoviePipeline* InPipeline);                                            // [0x76335a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetOverallSegmentCounts
	// void GetOverallSegmentCounts(class UMoviePipeline* InMoviePipeline, int32_t& OutCurrentIndex, int32_t& OutTotalCount);   // [0x7633440] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetOverallOutputFrames
	// void GetOverallOutputFrames(class UMoviePipeline* InMoviePipeline, int32_t& OutCurrentIndex, int32_t& OutTotalCount);    // [0x76332d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetMoviePipelineEngineChangelistLabel
	// FText GetMoviePipelineEngineChangelistLabel(class UMoviePipeline* InMoviePipeline);                                      // [0x76330e0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetMasterTimecode
	// FTimecode GetMasterTimecode(class UMoviePipeline* InMoviePipeline);                                                      // [0x7633030] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetMasterFrameNumber
	// FFrameNumber GetMasterFrameNumber(class UMoviePipeline* InMoviePipeline);                                                // [0x7632f20] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetMapPackageName
	// FString GetMapPackageName(class UMoviePipelineExecutorJob* InJob);                                                       // [0x7632d90] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetJobName
	// FText GetJobName(class UMoviePipeline* InMoviePipeline);                                                                 // [0x7632cd0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetJobInitializationTime
	// FDateTime GetJobInitializationTime(class UMoviePipeline* InMoviePipeline);                                               // [0x7632c30] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetJobAuthor
	// FText GetJobAuthor(class UMoviePipeline* InMoviePipeline);                                                               // [0x7632b50] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetEstimatedTimeRemaining
	// bool GetEstimatedTimeRemaining(class UMoviePipeline* InPipeline, FTimespan& OutEstimate);                                // [0x7632980] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetEffectiveOutputResolution
	// FIntPoint GetEffectiveOutputResolution(class UMoviePipelinePrimaryConfig* InPrimaryConfig, class UMoviePipelineExecutorShot* InPipelineExecutorShot); // [0x7632690] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentShotTimecode
	// FTimecode GetCurrentShotTimecode(class UMoviePipeline* InMoviePipeline);                                                 // [0x76325e0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentShotFrameNumber
	// FFrameNumber GetCurrentShotFrameNumber(class UMoviePipeline* InMoviePipeline);                                           // [0x76324f0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentSequence
	// class ULevelSequence* GetCurrentSequence(class UMoviePipeline* InMoviePipeline);                                         // [0x7632450] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentSegmentWorkMetrics
	// FMoviePipelineSegmentWorkMetrics GetCurrentSegmentWorkMetrics(class UMoviePipeline* InMoviePipeline);                    // [0x7632330] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentSegmentState
	// EMovieRenderShotState GetCurrentSegmentState(class UMoviePipeline* InMoviePipeline);                                     // [0x7632270] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentSegmentName
	// void GetCurrentSegmentName(class UMoviePipeline* InMoviePipeline, FText& OutOuterName, FText& OutInnerName);             // [0x7632090] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentFocusDistance
	// float GetCurrentFocusDistance(class UMoviePipeline* InMoviePipeline);                                                    // [0x7631f60] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentFocalLength
	// float GetCurrentFocalLength(class UMoviePipeline* InMoviePipeline);                                                      // [0x7631e50] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentExecutorShot
	// class UMoviePipelineExecutorShot* GetCurrentExecutorShot(class UMoviePipeline* InMoviePipeline);                         // [0x7631da0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentAperture
	// float GetCurrentAperture(class UMoviePipeline* InMoviePipeline);                                                         // [0x7631ca0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCompletionPercentage
	// float GetCompletionPercentage(class UMoviePipeline* InPipeline);                                                         // [0x7631ba0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.FindOrGetDefaultSettingForShot
	// class UMoviePipelineSetting* FindOrGetDefaultSettingForShot(class UClass* InSettingType, class UMoviePipelinePrimaryConfig* InPrimaryConfig, class UMoviePipelineExecutorShot* InShot); // [0x7631920] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.DuplicateSequence
	// class UMovieSceneSequence* DuplicateSequence(class UObject* Outer, class UMovieSceneSequence* InSequence);               // [0x76315e0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetConfigOrigin(class UMoviePipelineConfigBase* InConfig);                                                          // [0x765dd50] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.RemoveSetting
	// void RemoveSetting(class UMoviePipelineSetting* InSetting);                                                              // [0x75cd050] Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.GetUserSettings
	// TArray<UMoviePipelineSetting*> GetUserSettings();                                                                        // [0x765ce80] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.GetConfigOrigin
	// class UMoviePipelineConfigBase* GetConfigOrigin();                                                                       // [0x765c7b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.FindSettingsByClass
	// TArray<UMoviePipelineSetting*> FindSettingsByClass(class UClass* InClass, bool bIncludeDisabledSettings, bool bExactMatch); // [0x765c390] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.FindSettingByClass
	// class UMoviePipelineSetting* FindSettingByClass(class UClass* InClass, bool bIncludeDisabledSettings, bool bExactMatch); // [0x765c250] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.FindOrAddSettingByClass
	// class UMoviePipelineSetting* FindOrAddSettingByClass(class UClass* InClass, bool bIncludeDisabledSettings, bool bExactMatch); // [0x765c110] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.CopyFrom
	// void CopyFrom(class UMoviePipelineConfigBase* InConfig);                                                                 // [0x765bbd0] Native|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,1132) /* FMulticastInlineDelegate */ __um(OnExecutorFinishedDelegate);                        // 0x0028   (0x0010)  
	unsigned char                                      UnknownData00_6[0x18];                                      // 0x0038   (0x0018)  MISSED
	SDK_UNDEFINED(16,1133) /* FMulticastInlineDelegate */ __um(OnExecutorErroredDelegate);                         // 0x0050   (0x0010)  
	unsigned char                                      UnknownData01_6[0x20];                                      // 0x0060   (0x0020)  MISSED
	SDK_UNDEFINED(16,1134) /* FMulticastInlineDelegate */ __um(SocketMessageRecievedDelegate);                     // 0x0080   (0x0010)  
	SDK_UNDEFINED(16,1135) /* FMulticastInlineDelegate */ __um(HTTPResponseRecievedDelegate);                      // 0x0090   (0x0010)  
	...
	// void SetStatusProgress(float InProgress);                                                                                // [0x765ed30] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.SetStatusMessage
	// void SetStatusMessage(FString InStatus);                                                                                 // [0x765ebf0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.SetMoviePipelineClass
	// void SetMoviePipelineClass(class UClass* InPipelineClass);                                                               // [0x765e580] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.SendSocketMessage
	// bool SendSocketMessage(FString InMessage);                                                                               // [0x765dbc0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.SendHTTPRequest
	// int32_t SendHTTPRequest(FString InURL, FString InVerb, FString InMessage, TMap<FString, FString>& InHeaders);            // [0x765d9b0] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.OnExecutorFinishedImpl
	// void OnExecutorFinishedImpl();                                                                                           // [0x4d8d140] Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.OnExecutorErroredImpl
	// void OnExecutorErroredImpl(class UMoviePipeline* ErroredPipeline, bool bFatal, FText ErrorReason);                       // [0x765d2a0] Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.OnBeginFrame
	// void OnBeginFrame();                                                                                                     // [0x4c66b80] Native|Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.IsSocketConnected
	// bool IsSocketConnected();                                                                                                // [0x765d130] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.IsRendering
	// bool IsRendering();                                                                                                      // [0x4c65b30] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.GetStatusProgress
	// float GetStatusProgress();                                                                                               // [0x71199f0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.GetStatusMessage
	// FString GetStatusMessage();                                                                                              // [0x529e990] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.Execute
	// void Execute(class UMoviePipelineQueue* InPipelineQueue);                                                                // [0x7110330] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.DisconnectSocket
	// void DisconnectSocket();                                                                                                 // [0x765be90] Final|Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.ConnectSocket
	// bool ConnectSocket(FString InHostName, int32_t InPort);                                                                  // [0x765bae0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.CancelCurrentJob
	// void CancelCurrentJob();                                                                                                 // [0x502fe30] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.CancelAllJobs
	// void CancelAllJobs();                                                                                                    // [0x5302140] Native|Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void InitializeTransientSettings();                                                                                      // [0x765d050] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePrimaryConfig.GetTransientSettings
	// TArray<UMoviePipelineSetting*> GetTransientSettings();                                                                   // [0x765cf80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePrimaryConfig.GetEffectiveFrameRate
	// FFrameRate GetEffectiveFrameRate(class ULevelSequence* InSequence);                                                      // [0x765c850] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePrimaryConfig.GetAllSettings
	// TArray<UMoviePipelineSetting*> GetAllSettings(bool bIncludeDisabledSettings, bool bIncludeTransientSettings);            // [0x765c540] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnMapLoad(class UWorld* InWorld);                                                                                   // [0x765d3f0] Native|Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePythonHostExecutor.GetLastLoadedWorld
	// class UWorld* GetLastLoadedWorld();                                                                                      // [0x765ca20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePythonHostExecutor.ExecuteDelayed
	// void ExecuteDelayed(class UMoviePipelineQueue* InPipelineQueue);                                                         // [0x765c080] Native|Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool ShouldRender();                                                                                                     // [0x5302120] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetStatusProgress
	// void SetStatusProgress(float InProgress);                                                                                // [0x765edc0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetStatusMessage
	// void SetStatusMessage(FString InStatus);                                                                                 // [0x765ec90] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetShotOverridePresetOrigin
	// void SetShotOverridePresetOrigin(class UMoviePipelineShotConfig* InPreset);                                              // [0x765ea40] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetShotOverrideConfiguration
	// void SetShotOverrideConfiguration(class UMoviePipelineShotConfig* InPreset);                                             // [0x765e930] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetGraphPreset
	// void SetGraphPreset(class UMovieGraphConfig* InGraphPreset, bool bUpdateVariableAssignments);                            // [0x765e150] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.IsUsingGraphConfiguration
	// bool IsUsingGraphConfiguration();                                                                                        // [0x765d1f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetStatusProgress
	// float GetStatusProgress();                                                                                               // [0x765cf40] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetStatusMessage
	// FString GetStatusMessage();                                                                                              // [0x765ce80] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetShotOverridePresetOrigin
	// class UMoviePipelineShotConfig* GetShotOverridePresetOrigin();                                                           // [0x765cd20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetShotOverrideConfiguration
	// class UMoviePipelineShotConfig* GetShotOverrideConfiguration();                                                          // [0x5415660] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetOrCreateJobVariableAssignmentsForGraph
	// class UMovieJobVariableAssignmentContainer* GetOrCreateJobVariableAssignmentsForGraph(class UMovieGraphConfig* InGraph, bool bIsForPrimaryOverrides); // [0x765cb00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetGraphPreset
	// class UMovieGraphConfig* GetGraphPreset();                                                                               // [0x765c9a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetCameraName
	// FString GetCameraName(int32_t InCameraIndex);                                                                            // [0x765c670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.AllocateNewShotOverrideConfig
	// class UMoviePipelineShotConfig* AllocateNewShotOverrideConfig(class UClass* InConfigType);                               // [0x765b680] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetSequence(FSoftObjectPath InSequence);                                                                            // [0x765e830] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetPresetOrigin
	// void SetPresetOrigin(class UMoviePipelinePrimaryConfig* InPreset);                                                       // [0x765e620] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetIsEnabled
	// void SetIsEnabled(bool bInEnabled);                                                                                      // [0x765e220] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetGraphPreset
	// void SetGraphPreset(class UMovieGraphConfig* InGraphPreset, bool bUpdateVariableAssignments);                            // [0x765e080] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetConsumed
	// void SetConsumed(bool bInConsumed);                                                                                      // [0x765dff0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetConfiguration
	// void SetConfiguration(class UMoviePipelinePrimaryConfig* InPreset);                                                      // [0x765de30] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.OnDuplicated
	// void OnDuplicated();                                                                                                     // [0x3c0efc0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.IsUsingGraphConfiguration
	// bool IsUsingGraphConfiguration();                                                                                        // [0x765d180] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.IsEnabled
	// bool IsEnabled();                                                                                                        // [0x765d070] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.IsConsumed
	// bool IsConsumed();                                                                                                       // [0x4e4fef0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetStatusProgress
	// float GetStatusProgress();                                                                                               // [0x765cf00] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetStatusMessage
	// FString GetStatusMessage();                                                                                              // [0x765ce00] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetPresetOrigin
	// class UMoviePipelinePrimaryConfig* GetPresetOrigin();                                                                    // [0x765cc00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetOrCreateJobVariableAssignmentsForGraph
	// class UMovieJobVariableAssignmentContainer* GetOrCreateJobVariableAssignmentsForGraph(class UMovieGraphConfig* InGraph); // [0x765ca40] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetGraphPreset
	// class UMovieGraphConfig* GetGraphPreset();                                                                               // [0x765c920] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetConfiguration
	// class UMoviePipelinePrimaryConfig* GetConfiguration();                                                                   // [0x765c830] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetQueueOrigin(class UMoviePipelineQueue* InConfig);                                                                // [0x765e750] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.SetJobIndex
	// void SetJobIndex(class UMoviePipelineExecutorJob* InJob, int32_t Index);                                                 // [0x765e340] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.GetQueueOrigin
	// class UMoviePipelineQueue* GetQueueOrigin();                                                                             // [0x765cca0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.GetJobs
	// TArray<UMoviePipelineExecutorJob*> GetJobs();                                                                            // [0x75d1f00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.DuplicateJob
	// class UMoviePipelineExecutorJob* DuplicateJob(class UMoviePipelineExecutorJob* InJob);                                   // [0x765bed0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.DeleteJob
	// void DeleteJob(class UMoviePipelineExecutorJob* InJob);                                                                  // [0x765bde0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.DeleteAllJobs
	// void DeleteAllJobs();                                                                                                    // [0x765bda0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.CopyFrom
	// void CopyFrom(class UMoviePipelineQueue* InQueue);                                                                       // [0x765bc60] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.AllocateNewJob
	// class UMoviePipelineExecutorJob* AllocateNewJob(class UClass* InJobType);                                                // [0x765b5d0] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,1136) /* FMulticastInlineDelegate */ __um(OnRenderFinished);                                  // 0x0030   (0x0010)  
	...
	// void SetConfiguration(class UClass* InProgressWidgetClass, bool bRenderPlayerViewport);                                  // [0x765def0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.RenderQueueWithExecutorInstance
	// void RenderQueueWithExecutorInstance(class UMoviePipelineExecutorBase* InExecutor);                                      // [0x765d7f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.RenderQueueWithExecutor
	// class UMoviePipelineExecutorBase* RenderQueueWithExecutor(class UClass* InExecutorType);                                 // [0x765d680] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.RenderJob
	// void RenderJob(class UMoviePipelineExecutorJob* InJob);                                                                  // [0x765d480] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.IsRendering
	// bool IsRendering();                                                                                                      // [0x765d0a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.GetQueue
	// class UMoviePipelineQueue* GetQueue();                                                                                   // [0x765cc80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.GetActiveExecutor
	// class UMoviePipelineExecutorBase* GetActiveExecutor();                                                                   // [0x48ceb40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.AllocateJob
	// class UMoviePipelineExecutorJob* AllocateJob(class ULevelSequence* InSequence);                                          // [0x765b310] Final|Native|Public|BlueprintCallable 
};
...
{ 
	SDK_UNDEFINED(80,1137) /* TSet<UMovieGraphNode*> */ __um(VisitedNodes);                                        // 0x0000   (0x0050)  
};
